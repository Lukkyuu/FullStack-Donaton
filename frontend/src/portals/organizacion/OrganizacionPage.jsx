...
export default function OrganizacionPage() {
    ...
    <>
      <div style={{ padding:'20px 16px 16px', borderBottom:'1px solid rgba(255,255,255,0.07)' }}>
        <div style={{ display:'flex', alignItems:'center', gap:10 }}>
          ...
          <div>
            ...
            <div style={{ color:'rgba(255,255,255,0.4)', fontSize:10, marginTop:2 }}>Panel Organización</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding:'14px 10px', borderTop:'1px solid rgba(255,255,255,0.07)' }}>
        <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:10 }}>
          <div style={{ width:34, height:34, borderRadius:'50%', background:accentBg, display:'flex', alignItems:'center', justifyContent:'center', color:'#fff', fontWeight:600, fontSize:13, flexShrink:0 }}>
  ...
  return (
    <div className="app-layout">
      ...
      {/* Sidebar desktop */}
      <aside style={{ width:'var(--sidebar-w)', position:'fixed', top:0, left:0, height:'100vh', background:sidebarBg, display:'flex', flexDirection:'column', borderRight:'1px solid rgba(255,255,255,0.06)', zIndex:20 }} className="sidebar-desktop">
        <SidebarContent />
      </aside>

      {/* Sidebar mobile */}
      <aside style={{ position:'fixed', top:0, left:0, height:'100vh', width:260, background:sidebarBg, display:'flex', flexDirection:'column', zIndex:30, transform: sidebarOpen ? 'translateX(0)' : 'translateX(-100%)', transition:'transform 0.28s ease', boxShadow: sidebarOpen ? '4px 0 24px rgba(0,0,0,0.3)' : 'none' }} className="sidebar-mobile">
        <SidebarContent />
      </aside>
      ...
      <div className="main-content">
        <header style={{ height:60, background:'#fff', borderBottom:'1px solid var(--border)', display:'flex', alignItems:'center', padding:'0 24px', justifyContent:'space-between', position:'sticky', top:0, zIndex:10 }}>
          <div style={{ display:'flex', alignItems:'center', gap:12 }}>
            ...
            <span style={{ fontSize:13, color:'var(--text-muted)', fontWeight:500 }}>Portal Organización</span>
          </div>
          <div style={{ display:'flex', alignItems:'center', gap:12 }}>
            <NavLink to="/organizacion/notificaciones" style={{ position:'relative', background:'none', border:'1px solid var(--border-mid)', borderRadius:8, width:36, height:36, display:'flex', alignItems:'center', justifyContent:'center', fontSize:16, textDecoration:'none', color:'inherit' }}>
              🔔
